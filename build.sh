...
curl --fail https://raw.githubusercontent.com/beny23/static-distance/gh-pages/named_pubs.csv.gz | gunzip -dc > target/named_restaurants_filtered_restaurants_with_lat_lon.csv
